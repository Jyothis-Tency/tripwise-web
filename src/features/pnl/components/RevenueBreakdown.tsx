  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      <div className="grid gap-4 sm:gap-6 md:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="relative overflow-hidden rounded-2xl border border-blue-100 bg-blue-600 p-5 sm:p-6 shadow-md md:col-span-2 lg:col-span-1 flex flex-col justify-between">
          <div className="absolute -right-6 -top-6 h-32 w-32 rounded-full bg-white/10 blur-2xl"></div>
          <div className="absolute -left-6 -bottom-6 h-32 w-32 rounded-full bg-blue-500/50 blur-2xl"></div>
          ...
          <div className="relative flex items-start gap-4 z-10">
            ...
            <div>
              ...
              <p className="mt-1 text-[11px] sm:text-xs text-blue-200">
          ...
          <div className="relative z-10 mt-6 border-t border-white/20 pt-4">
            <h4 className="text-[10px] sm:text-[11px] font-bold uppercase tracking-widest text-white/60 mb-3">
              Additional Metrics
            </h4>
            <div className="grid grid-cols-2 gap-4">
              <div>
                <p className="text-[10px] sm:text-[11px] font-semibold uppercase tracking-wider text-blue-200">
                  Driver Salary
                </p>
                <p className="text-sm sm:text-base font-bold text-white mt-0.5">
                  ₹{Math.round(revenue.driverSalary || 0).toLocaleString()}
                </p>
              </div>
              {summary && (
                <div>
        ...
        {/* Agency profit from trips (agency cost − cab cost) */}
        <div className="rounded-2xl border border-violet-100 bg-white p-5 sm:p-6 shadow-sm transition-all hover:shadow-md">
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <div>
              ...
              <h3 className="text-lg sm:text-xl font-bold text-slate-900">
                ₹{tripsProfit.toLocaleString()}
              </h3>
            </div>
          </div>
          <p className="mt-4 text-xs text-slate-400">
            Agency profit from trip margins (agency cost minus cab cost)
          </p>
        </div>
      </div>
    </div>
