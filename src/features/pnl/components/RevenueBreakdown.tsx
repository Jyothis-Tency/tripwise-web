  ...
  return (
    <div className="space-y-6">
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        <div className="relative overflow-hidden rounded-2xl border border-indigo-100 bg-white p-6 shadow-sm md:col-span-2 lg:col-span-1">
          ...
          <div className="relative flex items-center gap-4">
            ...
            <div>
              ...
              <h3 className="text-2xl font-bold text-slate-900">₹{revenue.total.toLocaleString()}</h3>
            </div>
          </div>
        ...
        <div className="rounded-2xl border border-emerald-100 bg-white p-6 shadow-sm transition-all hover:shadow-md">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-sm font-medium text-slate-500">Commission Revenue</p>
              <h3 className="text-xl font-bold text-slate-900">₹{commission.toLocaleString()}</h3>
            </div>
          </div>
        ...
        {/* Trip Revenue Card */}
        <div className="rounded-2xl border border-blue-100 bg-white p-6 shadow-sm transition-all hover:shadow-md">
          <div className="flex items-center gap-4">
            <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-blue-50 text-blue-600">
              <Truck className="h-6 w-6" />
            </div>
            <div>
              <p className="text-sm font-medium text-slate-500">Trip Revenue</p>
              <h3 className="text-xl font-bold text-slate-900">₹{revenue.tripRevenue.toLocaleString()}</h3>
            </div>
          </div>
